...
SCOPE OF EFFECT (updated 2026-07-22): a manual ATG tree leaf
(...N-1C-inRing_..._3R!H-inRing_5R!H-inRing, rules.py entry 193) now delivers
this anchor to GENERATED benzylic+benzylic recombination/homolysis analogs via
an A*T^n rule fit to the thermo-reversed value over 648-1100 K (implied
dissociation reproduces this entry within ~5% in-window). Exact-match
depository retrieval of bibenzyl itself is unchanged.
...
SCOPE OF EFFECT (updated 2026-07-22): a manual ATG tree leaf
(..._N-2R-inRing_4R!H-inRing, rules.py entry 192) now delivers this anchor to
GENERATED aryl+benzylic recombination/homolysis analogs - including the
benchmark novolac methylene bridge (hydroxylated diphenylmethane) - via an
A*T^n rule fit to the thermo-reversed value over 673-1250 K (implied
dissociation reproduces this entry within ~13% in-window). Exact-match
depository retrieval of diphenylmethane itself is unchanged.
