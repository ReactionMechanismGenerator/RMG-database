...
entry(
    ...
    degeneracy = 1,
    kinetics = Arrhenius(
        A = (7.12e-12, 'cm^3/(molecule*s)'),
        n = 0.17,
        Ea = (0, 'kcal/mol'),
        T0 = (1, 'K'),
    ),
    rank = 3,
    shortDesc = u"""Training reaction from kinetics library: 2017_Lockhart_C4H6""",
    longDesc = 
u"""
Taken from entry: CH3 + C3H3 <=> 1_2-butadiene
""",
)

entry(
    index = 36,
    label = "CH3 + C3H3 <=> C4H6-2",
    degeneracy = 1,
    kinetics = Arrhenius(
        A = (7.12e-12, 'cm^3/(molecule*s)'),
        n = 0.17,
    ...
    longDesc = 
u"""
Taken from entry: CH3 + C3H3 <=> 1-butyne
""",
)
