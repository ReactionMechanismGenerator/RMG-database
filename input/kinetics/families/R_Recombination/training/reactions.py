...
entry(
    ...
    kinetics = Arrhenius(
        A = (1.78e+15, 's^-1'),
        n = 0,
        Ea = (261.07, 'kJ/mol', '+|-', 2.61),
        T0 = (1, 'K'),
        Tmin = (648, 'K'),
        Tmax = (748, 'K'),
    ),
    reference = Article(
        authors = ['Stein, S.E.', 'Robaugh, D.A.', 'Alfieri, A.D.', 'Miller, R.E.'],
        title = 'Bond homolysis in high-temperature fluids',
    ...
    referenceType = "experiment",
    rank = 5,
    shortDesc = u"""Stein/Robaugh/Alfieri/Miller 1982 VLPP - bibenzyl C-C homolysis, MEASURED""",
    longDesc =
u"""
MEASURED (primary anchor). Stein, S.E.; Robaugh, D.A.; Alfieri, A.D.; Miller, R.E.
"Bond homolysis in high-temperature fluids." J. Am. Chem. Soc. 104 (1982) 6567-6570.
Very-low-pressure pyrolysis (VLPP-MS), T = 648-748 K:
k = 1.78e15 * exp(-261.07 kJ/mol / RT) s^-1.
Uncertainty as recorded by NIST for the same study: Ea +/- 2.61 kJ/mol.
No unit conversion needed (unimolecular, A already in s^-1). Cross-check:
Ea = 261.07 kJ/mol / 4.184 = 62.40 kcal/mol.

Entered in the dissociation direction (family convention for dissociation
measurements in this training file, cf. former Buchanan entry and index 5003);
RMG reverses through thermochemistry for the R_Recombination forward direction.

Uncertainty band (independent high-T corroboration, MEASURED): Mueller-Markgraf, W.;
Troe, J. "Thermal decomposition of benzyl iodide and of benzyl radicals in shock
waves." J. Phys. Chem. 92 (1988) 4899-4905; shock tube / UV-vis, 0.24-2.48 bar Ar,
T = 900-1500 K: k = 7.94e14 * exp(-250.27 kJ/mol / RT) s^-1. Together the two
determinations span 648-1500 K and bound the uncertainty of this entry.

SUPERSESSION RECORD (phase-6 audit, 2026-07-17): this entry previously carried the
Buchanan, A. C. III; Dunstan, T. D. J.; Douglas, E. C.; Poutsma, M. L.
J. Am. Chem. Soc. 1986, 108, 7703 value (A = 2.0e15 s^-1, Ea = 62.9 kcal/mol,
623-1000 K), a surface-immobilized bibenzyl pyrolysis determination. It is
superseded by the Stein 1982 gas-phase VLPP primary measurement because the
gas-phase value carries a NIST-recorded uncertainty and matches the gas-phase
application of this family; the Buchanan value (and its gas-phase corroboration
by Sato et al., A = 6.3e14, Ea = 60.4 kcal/mol) is retained here as corroboration
and remains consistent with the present parameters.

SCOPE OF EFFECT: R_Recombination is autoGenerated=True on this branch, so this
training entry affects EXACT-MATCH depository retrieval only (bibenzyl <=> 2 benzyl
itself). Non-exact analogs - including the benchmark novolac methylene bridge
(hydroxylated diphenylmethane) - continue to receive the existing auto-generated
tree estimate. Folding this anchor into the fitted rate rules requires an ATG tree
regeneration, which is deliberately NOT done here (separate follow-up). No claim
that this entry changes generated-mechanism bridge rates is made.

Provenance class: MEASURED.
Evidence of record: CKMG ckmg/data/prereg/phase6_kinetics_evidence.md (phase-6),
entries 1.1 (primary) and 1.2 (uncertainty band).
""",
)
...
Provenance class: MEASURED (phase-6 audit, 2026-07-17: direct shock-tube
determination; classification per CKMG ckmg/data/prereg/phase6_kinetics_evidence.md
section 1.5 reconciliation - no value change).

SCOPE OF EFFECT: R_Recombination is autoGenerated=True on this branch, so this
training entry affects EXACT-MATCH depository retrieval only (ethylbenzene itself);
non-exact analogs continue to receive the existing auto-generated tree estimate
unless the ATG tree is regenerated.
""",
)

entry(
    index = 5004,
    label = "C13H12_diphenylmethane <=> C7H7 + C6H5",
    degeneracy = 2.0,
    kinetics = Arrhenius(
        A = (2.0e+15, 's^-1'),
        n = 0,
    ...
    reference = Article(
        ...
        pages = '5031-5039',
        year = '1984',
        url = 'https://doi.org/10.1021/j150665a048',
    ),
    referenceType = "review",
    rank = 6,
    shortDesc = u"""Rossi/McMillen/Golden 1984 - diphenylmethane C-C homolysis, EVALUATED (not measured)""",
    longDesc =
u"""
EVALUATED - NOT MEASURED. Rossi, M.J.; McMillen, D.F.; Golden, D.M.
J. Phys. Chem. 88 (1984) 5031-5039 (DOI 10.1021/j150665a048), ~1000-1250 K:
k = 2.0e15 * exp(-344.2 kJ/mol / RT) s^-1.
The paper's actual measurement is the benzylic C-H channel; this C-C homolysis
value is the authors' thermochemical-kinetics extrapolation, hence tagged
EVALUATED and never to be presented as MEASURED. NIST Chemical Kinetics Database
(CAS 101-81-5) carries no measured abstraction or C-C homolysis entries for
diphenylmethane (confirmed negative, retrieval 2026-07-17).

No unit conversion needed (unimolecular, A already in s^-1). Cross-check:
Ea = 344.2 kJ/mol / 4.184 = 82.27 kcal/mol.

Entered in the dissociation direction (family convention for dissociation
measurements/evaluations in this training file, cf. indices 5002 and 5003);
RMG reverses through thermochemistry for the R_Recombination forward direction.
degeneracy = 2.0: diphenylmethane has two equivalent Ph-CH2 bonds whose cleavage
gives the identical benzyl + phenyl product set; the A above is the total
(as-evaluated) rate over both paths.

SCOPE OF EFFECT: R_Recombination is autoGenerated=True on this branch, so this
training entry affects EXACT-MATCH depository retrieval only (diphenylmethane <=>
benzyl + phenyl itself). Non-exact analogs - including the benchmark novolac
methylene bridge (hydroxylated diphenylmethane) - continue to receive the existing
auto-generated tree estimate. Folding this anchor into the fitted rate rules
requires an ATG tree regeneration, which is deliberately NOT done here (separate
follow-up). No claim that this entry changes generated-mechanism bridge rates is
made.

Provenance class: EVALUATED.
Evidence of record: CKMG ckmg/data/prereg/phase6_kinetics_evidence.md (phase-6),
entry 1.3.
""",
)
