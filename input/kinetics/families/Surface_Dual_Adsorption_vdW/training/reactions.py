...
entry(
    index = 13,
    label = "H2O* + CO2X <=> CHO2X + OH*",
    degeneracy = 4.0,
    kinetics = SurfaceArrhenius(A=(3.48e+19,'cm^2/(mol*s)'), n=-0.031, Ea=(17.5,'kcal/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(3000,'K')),
    rank = 3,
...
entry(
    ...
    degeneracy = 1.0,
    kinetics = SurfaceArrhenius(A=(3.87e+21,'cm^2/(mol*s)'), n=0, Ea=(22192.7,'J/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(3000,'K')),
    rank = 3,
