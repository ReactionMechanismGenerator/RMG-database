...
entry(
    ...
    reference = Article(
        authors = [b'K. Wang', b'S. Villano', b'A. Dean'],
        title = b'Reactivity-Structure-Based Rate Estimation Rules for Alkyl Radical H Atom Shift and Alkenyl Radical Cycloaddition Reactions',
...
entry(
    ...
    reference = Article(
        authors = [b'H. Ismail', b'J. Park', b'B. M. Wong', b'W. H. Green', b'M. C. Lin'],
        title = b'A theoretical and experimental kinetic study of phenyl radical addition to butadiene',
...
entry(
    ...
    reference = Article(
        authors = [b'A. M. Mebel', b'Y. Georgievskii', b'A. W. Jasper', b'S. J. Klippenstein'],
        title = b'Pressure-dependent rate constants for PAH growth: formation of indene and its conversion to naphthalene',
        journal = b'Faraday Discussions',
        volume = b'195(0)',
        pages = b'637-670',
        year = b'2016',
    ),
...
entry(
    ...
    reference = Article(
        authors = [b'A. M. Mebel', b'A. Landera', b'R. I. Kaiser'],
        title = b'Formation Mechanisms of Naphthalene and Indene: From the Interstellar Medium to Combustion Flames',
        journal = b'Journal of Physical Chemistry A',
        volume = b'121(5)',
        pages = b'901-926',
        year = b'2017',
    ),
...
entry(
    ...
    reference = Article(
        authors = [b'Z. J. Buras', b'E. E. Dames', b'S. S. Merchant', b'G. Liu', b'R. M. I. Elsamra', b'W. H. Green'],
        title = b'Kinetics and Products of Vinyl + 1,3-Butadiene, a Potential Route to Benzene',
        journal = b'Journal of Physical Chemistry A',
        volume = b'119(28)',
        pages = b'7325-7338',
        year = b'2015',
...
entry(
    ...
    reference = Article(
        authors = [b'Z. J. Buras', b'T.-C. Chu', b'A. Jamal', b'N. W. Yee', b'J. E. Middaugh', b'W. H. Green'],
        title = b'Phenyl radical + propene: a prototypical reaction surface for aromatic-catalyzed 1,2-hydrogen-migration and subsequent resonance-stabilized radical formation',
...
entry(
    ...
    reference = Article(
        authors = [b'A. J. Vervust', b'M. R. Djokic', b'S. S. Merchant', b'H.-H. Carstensen', b'A. E. Long', b'G. B. Marin', b'W. H. Green', b'K. M. Van Geem'],
        title = b'Detailed Experimental and Kinetic Modeling Study of Cyclopentadiene Pyrolysis in the Presence of Ethene',
        journal = b'Energy & Fuels',
        volume = b'32(3)',
        pages = b'3920-3934',
        year = b'2018',
    ),
...
entry(
    ...
    reference = Article(
        authors = [b'A. M. Mebel', b'Y. Georgievskii', b'A. W. Jasper', b'S. J. Klippenstein'],
        title = b'Temperature- and pressure-dependent rate coefficients for the HACA pathways from benzene to naphthalene',
        journal = b'Proceedings of the Combustion Institute',
        volume = b'36(1)',
        pages = b'919-926',
        year = b'2017',
...
entry(
    ...
    reference = Article(
        authors = [b'Krasnoukhov, V. S.', b'Porfiriev, D. P.', b'Zavershinskiy, I. P.', b'Azyazov, V. N.', b'Mebel, A. M.'],
        title = b'Kinetics of the CH3 + C5H5 Reaction: A Theoretical Study',
...
entry(
    ...
    reference = Article(
        authors = [b'da Silva, G.', b'Cole, J. A.', b'Bozzelli, J. W.'],
        title = b'Kinetics of the Cyclopentadienyl + Acetylene, Fulvenallene + H, and 1-Ethynylcyclopentadiene + H Reactions',
        journal = b'The Journal of Physical Chemistry A',
        volume = b'114 (6)',
        pages = b'2275-2283',
        year = b'2010',
...
entry(
    ...
    reference = Article(
        authors = [b'Ribeiro, J. M.', b'Mebel, A. M.'],
        title = b'Reaction mechanism and product branching ratios of the CH + C3H4 reactions: a theoretical study',
        journal = b'Physical Chemistry Chemical Physics',
        volume = b'19 (22)',
        pages = b'14543-14554',
        year = b'2017',
...
entry(
    ...
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(4.11e+10,'s^-1'), n=0.19, Ea=(96.1065,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K')),
    rank = 0,
    shortDesc = """Aaron Vandeputte small GA method""",
    longDesc = 
"""
...
entry(
    ...
    reference = Article(
        authors = [b'I. V. Tokmakov', b'G. Kim', b'V. V. Kislov', b'A. M. Mebel', b'M. C. Lin'],
        title = b'The Reaction of Phenyl Radical with Molecular Oxygen: A G2M Study of the Potential Energy Surface',
        journal = b'J. Phys. Chem. A',
        volume = b'109 (27)',
        pages = b'6114-6127',
        year = b'2005',
...
entry(
    ...
    reference = Article(
        authors = [b'Gabriel da Silva', b'Adam J. Trevittb'],
        title = b'Chemically activated reactions on the C7H5 energy surface: propargyl+diacetylene, i-C5H3+acetylene, and n-C5H3+acetylene',
        journal = b'Phys. Chem. Chem. Phys.',
        volume = b'13 (19)',
        pages = b'8940-8952',
        year = b'2011',
    ),
...
entry(
    ...
    reference = Article(
        authors = [b'Sarah Khanniche', b'Lawrence Lai', b'William H. Green'],
        title = b'Kinetics of Intramolecular Phenyl Migration and Fused Ring Formation in Hexylbenzene Radicals',
        journal = b'J. Phys. Chem. A.',
        volume = b'122 (51)',
        pages = b'9778-9791',
        year = b'2018',
...
entry(
    ...
    reference = Article(
        authors = [b'Lawrence Lai', b'Hao-Wei Pang', b'William H. Green'],
        title = b'Formation of 2-Ring Aromatics in Hexylbenzene Pyrolysis',
        journal = b'Energy And Fuels',
        year = b'2019',
    ),
    referenceType = "theory",
    rank = 5,
