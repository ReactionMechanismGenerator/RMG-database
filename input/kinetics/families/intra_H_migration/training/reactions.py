...
entry(
    ...
    degeneracy = 2.0,
    kinetics = Arrhenius(A=(2.90675e+08,'s^-1'), n=0, Ea=(57.3664,'kJ/mol'),
...
entry(
    ...
    degeneracy = 1.0,
    kinetics=Arrhenius(A=(5.64481e+08,'s^-1'), n=0, Ea=(26.68,'kJ/mol'),
                       T0=(1,'K'), Tmin=(275,'K'), Tmax=(350,'K'),
...
entry(
    ...
    longDesc =
u"""
This is a "fake" reaction. Products are unstable so forward rate calculated using 
dlpno-ccsd(t)/def2-tzvp/def2-tzvp/c//wb97xd/def2tzvp
solvation: SMD water, sp was corrected using APFD/6-311+G(2d,p) SMD water
ts1038 forward only
TS geom
