...
entry(
    ...
    group = 
"""
1 *2 C   u[0,1]         {2,[S,D,B]} {3,S} {5,[S,D,T,B]}
2 *3 R!H u[1,2]     {1,[S,D,B]}
3 *4 H   u0         {1,S}
4 *1 R   u[1,2,3,4]
5    R!H ux         {1,[S,D,T,B]}
...
entry(
    ...
    group = 
"""
1 *2 C   u[0,1]     r0 {2,S} {3,S} {5,S} {8,S}
2 *3 C   u[1,2] r0 {1,S}
3 *4 H   u0     r0 {1,S}
...
entry(
    ...
    group = 
"""
1 *2 C u[0,1] r0 {2,S} {3,S} {5,S} {7,S}
2 *3 C u1 r0 {1,S}
3 *4 H u0 r0 {1,S}
4 *1 O u1 r0 {6,S}
5    C u0 r0 {1,S}
...
entry(
    ...
    group = 
"""
1 *2 C   u[0,1] r0 {2,S} {3,S} {5,S} {6,[S,D,T,B]}
2 *3 C   u1 r0 {1,S}
3 *4 H   u0 r0 {1,S}
4 *1 O   u1 r0
5    C   u0 r0 {1,S}
...
entry(
    ...
    group = 
"""
1 *2 C         u[0,1]         {2,[S,D,B]} {3,S} {5,[S,D,T,B]} {6,[S,D,T,B]}
2 *3 C         u[1,2]     {1,[S,D,B]}
3 *4 H         u0         {1,S}
4 *1 [H,C,N,S] u[1,2,3,4]
5    R!H       ux         {1,[S,D,T,B]}
...
entry(
    ...
    group = 
"""
1 *2 C   u[0,1] r0 {2,S} {3,S} {5,[S,D,T,B]} {6,[S,D,T,B]}
2 *3 C   u1 r0 {1,S}
3 *4 H   u0 {1,S}
4 *1 C   u1 r0 {7,T}
5    R!H ux {1,[S,D,T,B]}
...
entry(
    ...
    group = 
"""
1 *2 C   u[0,1]     r1 {2,[S,D,B]} {3,S} {5,[S,B]}
2 *3 R!H u[1,2] {1,[S,D,B]}
3 *4 H   u0     {1,S}
4 *1 C   u1     {6,[S,D,B]}
5    C   ux     {1,[S,B]}
...
entry(
    ...
    group = 
"""
1 *2 C   u[0,1]         r0 {2,[S,D,B]} {3,S} {5,[S,B]}
2 *3 R!H u[1,2]     {1,[S,D,B]}
3 *4 H   u0         {1,S}
4 *1 C   u[1,2,3,4] {6,[S,D,B]}
5    C   ux         {1,[S,B]}
...
entry(
    ...
    group = 
"""
1 *2 [C,N,S] u[0,1]     r0 {2,[S,D,B]} {3,S}
