...
entry(
    ...
    group = 
"""
1 *2 Cs  u0 {2,S} {5,[S,D,T,B,Q]} {6,[S,D,T,B,Q]} {7,[S,D,T,B,Q]}
2 *3 H   u0 {1,S}
3 *1 C   u0 p1 c-1 {4,T}
4 *4 O   u0 p1 c+1 {3,T}
5    R!H ux {1,[S,D,T,B,Q]}
...
2 *3 [Val7,Cd,Cs,S,Ct,N,Sis,Sid,Cb]   u0 r0 {1,S}
3 *1 C                                u0 p1 c-1 r0 {4,T}
4 *4 O                                u0 p1 c+1 r0 {3,T}
""",
    kinetics = None,
...
"""
L1: Root
    L2: Root_2CbCdCsCtHNSSidSisVal7->H
        L3: Root_2CbCdCsCtHNSSidSisVal7->H_1COCbCdCsCtHNOSSidSis->O
        L3: Root_2CbCdCsCtHNSSidSisVal7->H_N-1COCbCdCsCtHNOSSidSis->O
            L4: Root_2CbCdCsCtHNSSidSisVal7->H_N-1COCbCdCsCtHNOSSidSis->O_1CsH->H
            L4: Root_2CbCdCsCtHNSSidSisVal7->H_N-1COCbCdCsCtHNOSSidSis->O_N-1CsH->H
                L5: Root_2CbCdCsCtHNSSidSisVal7->H_N-1COCbCdCsCtHNOSSidSis->O_N-1CsH->H_Ext-1Cs-R
                    L6: Root_2CbCdCsCtHNSSidSisVal7->H_N-1COCbCdCsCtHNOSSidSis->O_N-1CsH->H_Ext-1Cs-R_Ext-1Cs-R
                        L7: Root_2CbCdCsCtHNSSidSisVal7->H_N-1COCbCdCsCtHNOSSidSis->O_N-1CsH->H_Ext-1Cs-R_Ext-1Cs-R_Ext-1Cs-R
    L2: Root_N-2CbCdCsCtHNSSidSisVal7->H
"""
)
