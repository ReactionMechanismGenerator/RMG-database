...
entry(
    index = 72,
    label = "S-Cs(HHH)S2s(S2s);CsJ-HHH",
    kinetics = ArrheniusEP(
        A = (3850, 'cm^3/(mol*s)'),
        n = 2.69,
        alpha = 0,
