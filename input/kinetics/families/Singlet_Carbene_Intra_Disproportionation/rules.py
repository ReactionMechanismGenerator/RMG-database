...
entry(
    index = 1,
    label = "Root",
    kinetics = ArrheniusBM(A=(6.77929e+18,'s^-1'), n=-2.03788, w0=(553800,'J/mol'), E0=(114156,'J/mol'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.8823225164718703, var=18.24904765813291, Tref=1000.0, N=5, data_mean=0.0, correlation='Root',), comment="""BM rule fitted to 5 training reactions at node Root
    Total Standard Deviation in ln(k): 10.780899292645342"""),
    rank = 11,
...
entry(
    ...
    kinetics = ArrheniusBM(A=(3.95159e+18,'s^-1'), n=-1.97082, w0=(539000,'J/mol'), E0=(112289,'J/mol'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.8305765209480382, var=17.041866923497537, Tref=1000.0, N=4, data_mean=0.0, correlation='Root_1C-inRing',), comment="""BM rule fitted to 4 training reactions at node Root_1C-inRing
