...
entry(
    ...
    longDesc = 
u"""
Taken from entry: Toluene + H <=> P1 + H2
""",
)
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: Toluene + H <=> P2 + H2
""",
)
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: Toluene + H <=> P3 + H2
""",
)
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: Toluene + H <=> P4 + H2
""",
)
