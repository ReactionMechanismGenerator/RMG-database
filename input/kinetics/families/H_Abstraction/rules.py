...
entry(
    ...
    kinetics = ArrheniusEP(
        ...
        Tmin = (300, 'K'),
        Tmax = (2000, 'K'),
        comment = 'Degeneracy not recalculated\n\nConverted to training reaction from rate rule: C/H3/Cs;InChI=1S/NO3/c2-1(3)4\n\nDegeneracy not recalculated\n\nConverted to training reaction from rate rule: C/H3/Cs;InChI=1S/NO3/c2-1(3)4',
    ),
    rank = 1,
