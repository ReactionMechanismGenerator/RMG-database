...
entry(
    ...
    group = 
"""
1 *1 Css u1 {2,S} {3,S} {4,S}
2 *2 Css u1 {1,S} {5,S} {6,S}
3    H  u0 {1,S}
4    H  u0 {1,S}
5    H  u0 {2,S}
6    H  u0 {2,S}
...
1 *1 Css           u1 {2,S} {3,S} {4,S}
2 *2 Css           u1 {1,S} {5,S} {6,S}
3    [Css,O2s,S2s] u0 c0 {1,S}
4    [Css,O2s,S2s] u0 c0 {1,S}
5    H            u0 {2,S}
6    H            u0 {2,S}
""",
    kinetics = None,
...
3    [O2d,S2d,N3d,Cdb,CO,CS,Cdd] u0 p2 c0 {1,D}
""",
    kinetics = None,
)
...
2 *2 [S2s,O2s]                  u1 p2 c0 {1,S}
3    [O2d,S2d,N3d,Cdb,CO,CS,Cdd] u0 p2 c0 {1,D}
4    [O2d,S2d,N3d,Cdb,CO,CS,Cdd] u0 p2 c0 {1,D}
""",
    kinetics = None,
)
