...
entry(
    ...
    kinetics = Arrhenius(A=(4.90e+09, 's^-1'), n=1.34, Ea=(142.2, 'kJ/mol'),
        ...
        comment = 'Fitted to 51 data points; dA = *|/ 1.61639, dn = +|- 0.0584997, dEa = +|- 0.583637 kJ/mol'),
    rank = 3,
...
entry(
    ...
    kinetics = Arrhenius(A=(4.52e+08, 's^-1'), n=1.06, Ea=(221.9, 'kJ/mol'),
        ...
        comment = 'Fitted to 51 data points; dA = *|/ 1.22202, dn = +|- 0.0250126, dEa = +|- 0.189603 kJ/mol'),
    rank = 3,
    shortDesc = u"""CCSD(T)-F12a/aug-cc-pVTZ//wB97x-D3/6-311++G(3df,3pd)""",
    longDesc =
u"""
...
entry(
    ...
    kinetics = Arrhenius(A=(9.04e+09, 's^-1'), n=0.95, Ea=(207.4, 'kJ/mol'),
        T0=(1, 'K'), Tmin=(300, 'K'), Tmax=(3000, 'K'),
        comment = 'Fitted to 51 data points; dA = *|/ 3.06808, dn = +|- 0.139852, dEa = +|- 1.06012 kJ/mol'),
    rank = 3,
    shortDesc = u"""CCSD(T)-F12a/aug-cc-pVTZ//wB97x-D3/6-311++G(3df,3pd)""",
    longDesc =
u"""
