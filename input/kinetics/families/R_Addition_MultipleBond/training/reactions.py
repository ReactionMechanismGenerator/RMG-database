...
entry(
    ...
    reference = Article(
        authors = [u"Garcia Dominguez, J.A.", u"Trotman-Dickenson, A.F."],
        ...
        journal = u"J. Chem. Soc.",
        pages = u"""940-944""",
        year = u"1962",
        url = u"http://kinetics.nist.gov/kinetics/Detail?id=1962GAR/TRO940-944:1",
    ),
    longDesc = 
u"""
...
entry(
    ...
    reference = Article(
        authors = [u"J. W. Allen", u"C. F. Goldsmith", u"W. H. Green"],
        title = u'Automatic Estimation of Pressure-Dependent Rate Coefficients',
        journal = u"Phys. Chem. Chem. Phys.",
        volume = u"???",
        pages = u"""???-???""",
        year = u"2011 (accepted)",
    ),
...
entry(
    ...
    reference = Article(
        authors = [u"Wang, K.", u"Villano, S.M.", u"Dean, A.M."],
        title = u'Reactions of allylic radicals that impact molecular weight growth kinetics',
        journal = u"PCCP",
        pages = u"""6255-6273""",
        year = u"2015",
        url = u"http://pubs.rsc.org/en/content/articlepdf/2015/CP/C4CP05308G",
    ),
    longDesc = 
u"""
...
entry(
    ...
    rank = 2,
    reference = Article(
        authors = [u'da Silva, G.', u'Cole, J. A.', u'Bozzelli, J. W.'],
...
entry(
    ...
    rank = 2,
    reference = Article(
        authors = [u'Krasnoukhov, V. S.', u'Porfiriev, D. P.', u'Zavershinskiy, I. P.', u'Azyazov, V. N.', u'Mebel, A. M.'],
...
entry(
    ...
    rank = 3,
    reference = Article(
        authors = [u'Senosiain, J. P.', u'Klippenstein, S. J.', u'Miller, J. A.'],
...
entry(
    ...
    rank = 3,
    reference = Article(
        authors = [u'Klippenstein, S. J.', u'Miller, J. A.'],
...
entry(
    ...
    rank = 3,
    reference = Article(
        authors = [u'Bao, J. L.', u'Zheng, J.', u'Truhlar, D. G.'],
        ...
        journal = u'Journal of the American Chemical Society',
        volume = u'138 (8)',
        pages = u'2690-2704',
        year = u'2016',
    ),
