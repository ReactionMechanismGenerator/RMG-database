...
entry(
    index = 3068,
    label = "Cds-CsCs_Cds-CsCs;OJ-O2s",
    kinetics = ArrheniusEP(
        A = (1.69, 'cm^3/(mol*s)'),
        n = 3.44,
        alpha = 0,
...
entry(
    index = 3070,
    label = "Cds-HH_Cds-Cs\O2s/H;CsJ-HHH",
    kinetics = ArrheniusEP(
        A = (532000, 'cm^3/(mol*s)'),
        n = 1.85,
        alpha = 0,
