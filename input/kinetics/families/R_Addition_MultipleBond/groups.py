...
3    [H,Cs,O2s,S2s,N3s,N5s]     u0    {1,S}
4    [H,Cs,O2s,S2s,N3s,N5s]     u0    {1,S}
""",
    kinetics = None,
)
...
"""
1 *3 N3s                u1 {2,S} {3,S}
2    [O2s,Cs,N3s,N5s,S2s] u0 {1,S}
3    [O2s,Cs,N3s,N5s,S2s] u0 {1,S}
""",
    kinetics = None,
)
