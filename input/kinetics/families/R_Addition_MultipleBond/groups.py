...
entry(
    ...
    group =
"""
1 *1 R!H!Val7 u0 {2,[D,T,B]}
2 *2 R!H!Val7 u0 {1,[D,T,B]}
""",
    kinetics = None,
)
...
entry(
    index = 11,
    label = "Cb-R!H!Val7_Cbf-R!H!Val7",
    group =
"""
1 *1 [Cb,Cbf] u0 {2,B} {3,B} {5,[S,B]}
