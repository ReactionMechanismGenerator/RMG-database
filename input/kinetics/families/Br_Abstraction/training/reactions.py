...
"""
Training reaction from kinetics library: autotst/Br_abstraction
Original entry: [CH3] + CCBr <=> CBr + C[CH2]
""",
)
...
"""
Training reaction from kinetics library: autotst/Br_abstraction
Original entry: [O]O + CDCDCBr <=> OOBr + C#C[CH2]
""",
)
...
"""
Training reaction from kinetics library: autotst/Br_abstraction
Original entry: [H] + [CH2]Br <=> Br + [CH2]
""",
)
...
entry(
    index = 53,
    label = "CBrClF2 + CBrF2 <=> CClF2 + CBr2F2",
    degeneracy = 1.0,
...
Original entry: CF2BRCL + CF2BR <=> CF2BR2 + CF2CL
""",
)
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: H + CF2BRCL <=> HBR + CF2CL
""",
)

entry(
    index = 59,
    label = "CHBrF2 + H <=> CHF2 + BrH",
    degeneracy = 1.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: CHF2BR + H <=> CHF2 + HBR
""",
)

entry(
    index = 60,
    label = "CBrClF2 + CH3 <=> CClF2 + CH3Br",
    degeneracy = 1.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: CH3 + CF2BRCL <=> CH3BR + CF2CL
""",
)
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: BRCL + H <=> HBR + CL
""",
)

entry(
    index = 66,
    label = "CBrClF2 + O <=> CClF2 + BrO",
    degeneracy = 1.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: O + CF2BRCL <=> BRO + CF2CL
""",
)

entry(
    index = 67,
    label = "CBrClF2 + HO <=> CClF2 + BrHO",
    degeneracy = 1.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: OH + CF2BRCL <=> CF2CL + BROH
""",
)

entry(
    index = 68,
    label = "CBrClF2 + CF3-2 <=> CClF2 + CBrF3-2",
    degeneracy = 1.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: CF3 + CF2BRCL <=> CF2CL + CF3BR
""",
)

entry(
    index = 69,
    label = "CBr2F2-2 + H <=> CBrF2-2 + BrH",
    degeneracy = 2.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: H + CF2BR2 <=> HBR + CF2BR
""",
)

entry(
    index = 70,
    label = "CBr2F2-2 + HO <=> CBrF2-2 + BrHO",
    degeneracy = 2.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: OH + CF2BR2 <=> CF2BR + BROH
""",
)

entry(
    index = 71,
    label = "CBr2F2-2 + CH3 <=> CBrF2-2 + CH3Br",
    degeneracy = 2.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: CH3 + CF2BR2 <=> CF2BR + CH3BR
""",
)

entry(
    index = 72,
    label = "CBr2F2-2 + CF3-2 <=> CBrF2-2 + CBrF3-2",
    degeneracy = 2.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: CF3 + CF2BR2 <=> CF2BR + CF3BR
""",
)

entry(
    index = 73,
    label = "C2Br2F4 + H <=> C2BrF4 + BrH",
    degeneracy = 2.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: C2F4BR2 + H <=> C2F4BR + HBR
""",
)

entry(
    index = 74,
    label = "C2Br2F4 + CF3-2 <=> C2BrF4 + CBrF3-2",
    degeneracy = 2.0,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: C2F4BR2 + CF3 <=> CF3BR + C2F4BR
""",
)

entry(
    index = 75,
    label = "C2BrClF4 + H <=> C2ClF4 + BrH",
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(1e+15,'cm^3/(mol*s)'), n=0, Ea=(30000,'cal/mol'), T0=(1,'K')),
    rank = 3,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: C2F4BRCL + H <=> C2F4CL + HBR
""",
)

entry(
    index = 76,
    label = "C2BrClF4 + CF3-2 <=> C2ClF4 + CBrF3-2",
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(3e+12,'cm^3/(mol*s)'), n=0, Ea=(11300,'cal/mol'), T0=(1,'K')),
    rank = 3,
...
"""
Training reaction from kinetics library: CF2BrCl
Original entry: C2F4BRCL + CF3 <=> CF3BR + C2F4CL
""",
)
