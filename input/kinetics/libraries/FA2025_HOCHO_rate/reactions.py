...
entry(
    ...
    kinetics = Chebyshev(
        coeffs = [
            [-12.2527,0.455975,0.057275,-0.006759],
            [16.104,0.5067,0.11423,-0.01098],
            [0.460215,-0.072525,0.076815,-0.004207],
            [-0.52721,-0.05701,-0.00917,0.002808],
            [-0.36329,0.230435,-0.061655,0.004807],
            [-0.138123,0.20305,-0.035921,0.00192]
        ],
        kunits = 'cm^3/(mol*s)',
        Tmin=(300,'K'), 
        Tmax=(3000,'K'), 
    ...
    u"""
    From the pressure-dependent kinetic network of the singlet CH2O2 PES calculated at
    the CCSD(T)-F12/aug-cc-pVTZ-F12//B2PLYP-D3/def2-TZVP level of theory. Increasd by a factor of 100.   
    """,
)
