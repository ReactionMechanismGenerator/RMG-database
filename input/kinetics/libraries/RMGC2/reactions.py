...
name = "RMGC2"
shortDesc = u"C2 seed mechanism for RMG jobs"
longDesc = u"""

Most reactions taken from Klippenstein_Glarborg2016 with desc:  
...
Reactions not included from Klippenstein_Glarborg2016
CH3OO + CH2O <=> CH3OOH + HCO (superceded by a Colin Grambow calculation)
C2H4 + O (superceded by C2H4+O_Klip2017 library)

added C2H4+O_Klip2017 with desc:  
...
entry(
    ...
    longDesc = 
    u"""
[144] Bozzelli,J.W. J Phys. Chem. 1993, 97 , 4427. RRKM extrapolation. O2 +HCO -->HC(O)O2. C.D.W. divided rate expression by 2, to get rate of addition per site
""",
)

entry(
    index = 589,
    label = "HO2 + OCHOOH <=> OCHOO + H2O2",
    degeneracy = 1.0,
    kinetics = Arrhenius(
        A = (4.1e-2, 'm^3/(mol*s)'),
        n = 2.50,
    ...
    longDesc = 
u"""
Estimated by analogy from CH3OOH + HO2 => CH3OO + H2O2 (which was an experimental value)
""",
)
...
entry(
    ...
    longDesc = 
u"""
Assumed to be the third primary branching of 
HO2 + CH3 => CH4 + O2
HO2 + CH3 => CH3O + OH
the above two rates from Klippenstein_Glarborg2016 were fit to a total rate at 829-1500 K and extrapolated down
The difference between this total rate and the two rates above was taken to be the 
above rate for HO2 + CH3 => CH3OOH
""",
)
