...
name = "Aromatics_high_pressure/C10H10-1"
shortDesc = u"Benzyl radical recombinaing with propargl radical"
longDesc = u"""
Computational Study on the Recombination Reaction between Benzyl and Propargyl Radicals
AKIRA MATSUGI, AKIRA MIYOSHI
International Journal of Chemical Kinetics, 2012, 44, 206-218

Calculations were performed at the CASPT2/cc-pVTZ//B3LYP/6-311G(d,p) level of theory
"""
entry(
    index = 1,
    label = "C3H3 + C7H7 <=> W1",
