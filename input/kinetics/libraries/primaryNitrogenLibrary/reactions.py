...
frequencies calculated at B3LYP/6-311+g(2d,pd) freq iop(7/33=1) 
rotor for N4H6 calculated at B3LYP/6-311g(2d,pd)
Not using BAC
""",
)
...
entry(
    index = 247,
    label = "N2H4 + H2NN(S) <=> NH2NHN(S) + NH3",
    degeneracy = 1,
    kinetics = Chebyshev(
        coeffs = [
