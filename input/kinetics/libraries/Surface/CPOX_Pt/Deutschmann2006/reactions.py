...
entry(
    ...
    kinetics = StickingCoefficient(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        cov = {'Pt': {'E': (0.0, 'J/mol'), 'm': -1.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
    longDesc = u"""R1""",
	metal = "Pt",
...
entry(
    ...
    kinetics = SurfaceArrhenius(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        cov = {'OX': {'E': (-8000, 'J/mol'), 'm': 0.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
    longDesc = u"""R4""",
	metal = "Pt",
...
entry(
    ...
    kinetics = SurfaceArrhenius(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        cov = {'OCX': {'E': (33000, 'J/mol'), 'm': 0.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
...
entry(
    ...
    kinetics = SurfaceArrhenius(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        cov = {'HX': {'E': (2800, 'J/mol'), 'm': 0.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
    longDesc = u"""R21""",
	metal = "Pt",
...
entry(
    ...
    kinetics = SurfaceArrhenius(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        cov = {'OX': {'E': (-240600, 'J/mol'), 'm': 0.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
...
entry(
    ...
    kinetics = StickingCoefficient(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        cov = {'CX': {'E': (-4600, 'J/mol'), 'm': 0.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
    longDesc = u"""R31""",
	metal = "Pt",
