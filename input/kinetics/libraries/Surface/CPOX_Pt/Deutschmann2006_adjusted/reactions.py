...
entry(
    ...
    kinetics = StickingCoefficient(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        coverage_dependence = {'Pt': {'E': (0.0, 'J/mol'), 'm': -1.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
    longDesc = u"""R1""",
	metal = "Pt",
...
entry(
    ...
    kinetics = SurfaceArrhenius(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        coverage_dependence = {'OX': {'E': (8000, 'J/mol'), 'm': 0.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
...
#        Tmin = (200, 'K'),
#        Tmax = (3000, 'K'),
#        coverage_dependence = {'HX': {'E': (-10000.0, 'J/mol'), 'm': 0.0, 'a': 0.0}},
#    ),
#    shortDesc = u"""Default""",
#    longDesc = u"""R9""",
#    metal = "Pt",
...
entry(
   ...
   kinetics = SurfaceArrhenius(
       ...
       Tmin = (200, 'K'),
       Tmax = (3000, 'K'),
       coverage_dependence = {'OX': {'E': (-188280, 'J/mol'), 'm': 0.0, 'a': 0.0}},
   ),
   shortDesc = u"""Default""",
...
entry(
   ...
   kinetics = SurfaceArrhenius(
       ...
       Tmin = (200, 'K'),
       Tmax = (3000, 'K'),
       coverage_dependence = {'OCX': {'E': (-33000, 'J/mol'), 'm': 0.0, 'a': 0.0}},
   ),
   shortDesc = u"""Default""",
...
#        Tmin = (200, 'K'),
#        Tmax = (3000, 'K'),
#        coverage_dependence = {'OX': {'E': (94140, 'J/mol'), 'm': 0.0, 'a': 0.0}},
#    ),
#    shortDesc = u"""Default""",
...
entry(
   ...
   kinetics = SurfaceArrhenius(
       ...
       Tmin = (200, 'K'),
       Tmax = (3000, 'K'),
       coverage_dependence = {'OCX': {'E': (-30000, 'J/mol'), 'm': 0.0, 'a': 0.0}},
   ),
   shortDesc = u"""Default""",
...
entry(
    ...
    kinetics = SurfaceArrhenius(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        coverage_dependence = {'HX': {'E': (-2800, 'J/mol'), 'm': 0.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
    longDesc = u"""R21""",
	metal = "Pt",
...
entry(
   ...
   kinetics = SurfaceArrhenius(
       ...
       Tmin = (200, 'K'),
       Tmax = (3000, 'K'),
       coverage_dependence = {'CX': {'E': (50000, 'J/mol'), 'm': 0.0, 'a': 0.0}},
   ),
   shortDesc = u"""Default""",
   longDesc = u"""R22""",
	 metal = "Pt",
...
entry(
   ...
   kinetics = SurfaceArrhenius(
       ...
       Tmin = (200, 'K'),
       Tmax = (3000, 'K'),
       coverage_dependence = {'OX': {'E': (-73220, 'J/mol'), 'm': 0.0, 'a': 0.0}},
   ),
   shortDesc = u"""Default""",
   longDesc = u"""R27""",
   metal = "Pt",
...
entry(
   ...
   kinetics = SurfaceArrhenius(
       ...
       Tmin = (200, 'K'),
       Tmax = (3000, 'K'),
       coverage_dependence = {'OX': {'E': (167360, 'J/mol'), 'm': 0.0, 'a': 0.0}},
   ),
   shortDesc = u"""Default""",
...
entry(
    ...
    kinetics = SurfaceArrhenius(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        coverage_dependence = {'OX': {'E': (-240580, 'J/mol'), 'm': 0.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
...
entry(
    ...
    kinetics = StickingCoefficient(
        ...
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
        coverage_dependence = {'CX': {'E': (4600, 'J/mol'), 'm': 0.0, 'a': 0.0}},
    ),
    shortDesc = u"""Default""",
    longDesc = u"""R31""",
	metal = "Pt",
...
entry(
   ...
   kinetics = SurfaceArrhenius(
       ...
       Tmin = (200, 'K'),
       Tmax = (3000, 'K'),
       coverage_dependence = {'HX': {'E': (-28000, 'J/mol'), 'm': 0.0, 'a': 0.0}},
   ),
   shortDesc = u"""Default""",
   longDesc = u"""R34""",
   metal = "Pt",
