...
#Be careful about this reaction A = 5.9E15 is too fast, will cause a problem
entry(
    index = 10,
    label = "H2O_X <=> H2O + X",
    kinetics = SurfaceArrhenius(
...
entry(
    ...
    label = "NO_X <=> NO + X",
    kinetics = SurfaceArrhenius(
        A = (2.6E15, '1/s'), #revise A=2.6E17 to A=2.6E15 and match the coverage plot 
        n = 0.0,
        Ea = (221927, 'J/mol'),  
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
...
entry(
    ...
    label = "N2O_X <=> N2O + X",
    kinetics = SurfaceArrhenius(
        A = (1.4E16, '1/s'), #revise A=1.4E16 to A=1.4E10, this scale is close to the value from Deutschmann's Nitrogen library and better match the models
        n = 0.0,
        Ea = (11578.8, 'J/mol'),  
        Tmin = (200, 'K'),
        Tmax = (3000, 'K'),
