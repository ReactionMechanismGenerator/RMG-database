...
entry(
    ...
    kinetics = Chebyshev(
    coeffs=[
        [4.418e+00,  2.253e+00, -1.314e-01, -4.125e-02],
        [1.769e+00,  2.911e-01,  1.432e-01,  3.364e-02],
        [4.802e-01, -5.148e-02, -1.762e-02,  3.210e-03],
        [5.269e-02, -1.190e-02, -5.441e-03, -3.967e-04],
        [-1.964e-02, 1.149e-02,  4.724e-03,  4.074e-04],
        [7.993e-03, -2.318e-03, -6.434e-04,  9.579e-05],
    ],
    kunits='cm^3/(mol*s)',
    Tmin=(200, 'K'), Tmax=(3500, 'K'),
    Pmin=(0.001,'bar'), Pmax=(100.0,'bar'),
    ),
    shortDesc=u"""FA2025""",
    longDesc=
    u"""
...
entry(
    ...
    kinetics = Chebyshev(
        coeffs = [
        [4.060e+00,  1.841e+00, -1.235e-01, -4.480e-03],
        [4.663e+00,  7.273e-01,  1.186e-01, -2.632e-03],
        [-1.752e-01, -1.395e-02,  1.539e-02,  5.630e-03],
        [-9.920e-02, -3.604e-02, -5.277e-03,  1.933e-03],
        [-4.167e-02, -1.084e-02, -3.327e-03,  6.367e-04],
        [1.974e-03, -8.384e-03, -1.177e-03, -7.746e-04],
        ],
        kunits = 'cm^3/(mol*s)',
        Tmin = (200, 'K'),
        Tmax = (3500, 'K'),
...
entry(
    ...
    kinetics = Chebyshev(
    coeffs=[
        [1.118e+01, -3.644e-01, -1.881e-01, -5.313e-02],
        [7.810e-01,  3.481e-01,  1.654e-01,  3.342e-02],
        [3.028e-01,  1.919e-02,  1.952e-02,  1.344e-02],
        [1.514e-01, -5.623e-03, -5.437e-04,  2.277e-03],
        [7.362e-02, -1.707e-03, -1.729e-03, -8.517e-04],
        [2.732e-02, -1.047e-02, -4.317e-03, -4.006e-04],
    ],
    kunits='cm^3/(mol*s)',
    Tmin=(200, 'K'), Tmax=(3500, 'K'),
    Pmin=(0.001,'bar'), Pmax=(100.0,'bar'),
...
entry(
    ...
    label="OCHO <=> HOCO",
    kinetics = Chebyshev(
        coeffs=[[-1.78577,3.13209,-0.124536,-0.00864198],
                [4.13381,1.79679,0.128226,-0.00542689],
                [1.14815,0.28817,-0.0536911,-0.00990279],
                [-0.0179973,-0.151261,0.000441947,0.000467672],
                [-0.192719,-0.112617,0.0194046,0.0040788],
                [-0.00770093,-0.0184555,-0.00202617,0.00178373]
                ],
        kunits='1/s', 
        Tmin=(200, 'K'), Tmax=(3500, 'K'),
        Pmin=(0.001,'bar'), Pmax=(100.0,'bar'),
...
entry(
    ...
    label="OH + CO <=> HOCO",
    kinetics = Chebyshev(
    coeffs=[[9.92881,1.97708,-0.256939,-0.0611574],
            [-0.255562,0.34976,0.153416,0.0200133],
            [-0.119261,0.0657176,0.0392229,0.0146487],
            [-0.0626391,0.0244442,0.0138362,0.00508249],
            [-0.0687199,0.0123504,0.00516011,0.00078253],
            [0.00444256,-0.00628459,-0.000661177,0.00162794]
            ], 
        kunits='cm^3/(mol*s)', 
        Tmin=(200, 'K'), Tmax=(3500, 'K'),
        Pmin=(0.001,'bar'), Pmax=(100.0,'bar'),
...
entry(
    ...
    label="H + CO2 <=> HOCO",
    kinetics = Chebyshev(
    coeffs=[[2.31665,0.640503,-0.050956,-0.00155075],
            [6.33612,1.02635,-0.0589861,-0.00309194],
            [1.08015,0.483934,0.0118426,-0.0021944],
            [-0.260657,0.0918996,0.0393304,0.000857578],
            [-0.202253,-0.0116035,0.021085,0.00166103],
            [-0.0111355,0.00845843,-0.000351274,-0.000416312]
            ],
        kunits='cm^3/(mol*s)', 
        Tmin=(300,'K'), 
        Tmax=(3000,'K'), 
