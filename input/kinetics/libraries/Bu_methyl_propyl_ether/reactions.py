...
entry(
    ...
    longDesc =
u"""
RMG pre decision tree estimator estimate
""",
)

entry(
    index = 91,
    label = "MPO + O2 <=> HO2 + MPO1J",
    elementary_high_p = True,
    degeneracy = 2.0,
    kinetics = Arrhenius(
        A = (4.718e2,'cm^3/(mol*s)'),
        n = 3.380,
        Ea = (45.981, 'kcal/mol'),
        T0 = (1, 'K'),
        Tmin = (300, 'K'),
...
# entry( #too fast
#     index = 92,
#     label = "PME + CH3 <=> CH4 + MPO1J",
#     elementary_high_p = True,
#     degeneracy = 2.0,
#     kinetics = Arrhenius(
#         A = (3.549e-14,'cm^3/(mol*s)'),
#         n = 10.136,
#         Ea = (21.095, 'kcal/mol'),
#         T0 = (1, 'K'),
#         Tmin = (300, 'K'),
...
entry( 
    index = 94,
    label = "MPO + CH3OO <=> CH3OOH + MPO1J",
    elementary_high_p = True,
    degeneracy = 2.0,
    kinetics = Arrhenius(
        A = (5.582e-5,'cm^3/(mol*s)'),
        n = 5.074,
        Ea = (6.681, 'kcal/mol'),
        T0 = (1, 'K'),
        Tmin = (300, 'K'),
...
entry( 
    index = 95,
    label = "CH3CHCHO + O2 <=> CH2CHCHO + HO2",
    elementary_high_p = True,
    degeneracy = 3.0,
    kinetics = Arrhenius(
        A = (3.352e-2,'cm^3/(mol*s)'),
        n = 3.603,
        Ea = (3.286, 'kcal/mol'),
        T0 = (1, 'K'),
        Tmin = (300, 'K'),
