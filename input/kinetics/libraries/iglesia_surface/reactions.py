...
# entry(
#     index = 14,
#     label = "NO + C3H6 <=> C3H5 + HNO",
#     kinetics = Arrhenius(A=(1.0e+14, 'cm^3/(mol*s)'), n=0.0, Ea=(0, 'kcal/mol'), T0=(1, 'K')),
#     longDesc =
# u"""
#
# """,
...
# add additional reactions for the intermediate species entering the cat reactor from reactor 1
