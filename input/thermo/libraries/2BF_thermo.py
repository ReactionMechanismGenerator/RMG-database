...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[3.69874,0.0459091,3.03309e-05,-6.21175e-08,2.42369e-11,-4367.61,15.2042], Tmin=(10,'K'), Tmax=(981.222,'K')),
            NASAPolynomial(coeffs=[6.85582,0.0599555,-3.22892e-05,8.38467e-09,-8.48822e-13,-6282.92,-6.5698], Tmin=(981.222,'K'), Tmax=(3000,'K')),
        ],
        Tmin = (10,'K'),
        Tmax = (3000,'K'),
        E0 = (-36.2446,'kJ/mol'),
...
* Invalidated! pivots: [5, 6], dihedral: [1, 5, 6, 3], invalidation reason: Another conformer for P1 exists which is 2.28 kJ/mol lower.
...
C      -1.89342300   -0.07189700   -1.64092800
...
C       1.61301400    0.59120500   -4.79895000
C       1.73365600   -0.41104000   -3.87483600
...
H      -0.05913400    2.05072000   -5.08824100
