...
shortDesc = u"This library includes species of C6H5+O2 PES, first_to_second_ring 10 pathways (2017 Mebel), naphthyl+acetylene HACA surfaces, biphenyl decomposition, and other large PAHs up to 	Benzo[a]pyrene (C20H12)"
longDesc = u"""Dr. Istvan Lengyel calculates species (except for biphenyl C12H10 calculated by Max Liu) at CBS-QB3 in Gaussian09. The calculation was done for the lowest energy conformer, but the rotor scan was not performed. By using CanTherm, the thermo properties were evaluated, where bond corrections value in Petersson et al. 1998 (https://doi.org/10.1063/1.477794 bond corrections) were used since it considered aromatic species.
"""
entry(
    index = 0,
    label = "C4H3O2_6",
