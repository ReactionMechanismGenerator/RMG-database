...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [4.05392, -0.00590936, 0.000256079, -4.22706e-07, 2.21316e-10, 2695.1, 11.8848],
                Tmin = (10, 'K'),
                Tmax = (594.817, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-4.42836, 0.0838264, -5.26635e-05, 1.57375e-08, -1.79925e-12, 3125.8, 43.5385],
                Tmin = (594.817, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [4.00206, -0.00211494, 0.000260754, -4.42511e-07, 2.37474e-10, 18697.1, 13.8268],
                Tmin = (10, 'K'),
                Tmax = (577.903, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-4.52445, 0.0883504, -5.56846e-05, 1.66959e-08, -1.91436e-12, 19157.5, 45.7433],
                Tmin = (577.903, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.61113, 0.04184, 0.000154103, -2.54747e-07, 1.16634e-10, -8852.73, 13.9527],
                Tmin = (10, 'K'),
                Tmax = (731.126, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-1.32933, 0.108466, -6.3825e-05, 1.80415e-08, -1.97247e-12, -9188.61, 29.0029],
                Tmin = (731.126, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.59611, 0.0467608, 0.000142186, -2.32308e-07, 1.02565e-10, 5108.84, 14.6881],
                Tmin = (10, 'K'),
                Tmax = (769.623, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.49624, 0.110356, -6.42537e-05, 1.79727e-08, -1.94624e-12, 4485.24, 25.216],
                Tmin = (769.623, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.94447, 0.00371676, 0.000199109, -3.98552e-07, 2.61611e-10, 16370.8, 11.5954],
                Tmin = (10, 'K'),
                Tmax = (391.042, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.19466, 0.0665475, -4.20309e-05, 1.27717e-08, -1.49365e-12, 16850.7, 35.4456],
                Tmin = (391.042, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.94238, 0.00373416, 0.000189866, -3.65712e-07, 2.29978e-10, 16986.8, 11.9908],
                Tmin = (10, 'K'),
                Tmax = (408.683, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.52355, 0.0669984, -4.2256e-05, 1.28111e-08, -1.49441e-12, 17515.5, 37.4016],
                Tmin = (408.683, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.94037, 0.0036795, 0.000177415, -3.21449e-07, 1.88627e-10, 17003.7, 12.4861],
                Tmin = (10, 'K'),
                Tmax = (440.105, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.18625, 0.0684702, -4.34733e-05, 1.32476e-08, -1.55121e-12, 17630.9, 41.0168],
                Tmin = (440.105, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.92063, 0.00475061, 0.000180439, -3.25908e-07, 1.86072e-10, 17850.8, 11.3844],
                Tmin = (10, 'K'),
                Tmax = (522.294, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.5955, 0.068928, -4.48671e-05, 1.40017e-08, -1.67289e-12, 18336.7, 36.7249],
                Tmin = (522.294, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [2.5092, 0.155564, -0.000463959, 1.07605e-06, -8.99619e-10, 1053.67, 17.3803],
                Tmin = (10, 'K'),
                Tmax = (410.116, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.830447, 0.118095, -7.07428e-05, 2.04243e-08, -2.28096e-12, 1916.62, 37.6967],
                Tmin = (410.116, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [2.46487, 0.159417, -0.000477704, 1.08646e-06, -8.93664e-10, 1408.36, 17.0356],
                Tmin = (10, 'K'),
                Tmax = (413.815, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.387576, 0.116927, -6.97228e-05, 2.00563e-08, -2.23347e-12, 2244.32, 35.5284],
                Tmin = (413.815, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [2.43449, 0.164299, -0.000527222, 1.22987e-06, -1.02501e-09, 1333.37, 16.4861],
                Tmin = (10, 'K'),
                Tmax = (409.466, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.766387, 0.117535, -7.00532e-05, 2.01241e-08, -2.23728e-12, 2249.66, 37.0584],
                Tmin = (409.466, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [2.57652, 0.146954, -0.000385042, 8.72638e-07, -7.31177e-10, 2016.64, 17.3622],
                Tmin = (10, 'K'),
                Tmax = (409.446, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.418165, 0.11887, -7.20885e-05, 2.10489e-08, -2.37357e-12, 2742.52, 35.0052],
                Tmin = (409.446, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.72076, 0.0241095, 0.000129351, -2.38191e-07, 1.28204e-10, 12761.5, 13.1131],
                Tmin = (10, 'K'),
                Tmax = (589.69, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.734489, 0.0733613, -4.43407e-05, 1.29026e-08, -1.44971e-12, 12956.1, 29.4485],
                Tmin = (589.69, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.72371, 0.0274434, 9.94458e-05, -1.67849e-07, 7.8708e-11, 13023.8, 13.0931],
                Tmin = (10, 'K'),
                Tmax = (707.48, 'K'),
            ),
            NASAPolynomial(
                coeffs = [0.2413, 0.0705396, -4.15544e-05, 1.17818e-08, -1.29269e-12, 12930.8, 24.5487],
                Tmin = (707.48, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.92062, 0.0056912, 0.000263076, -5.86562e-07, 4.33651e-10, 13070.7, 13.7483],
                Tmin = (10, 'K'),
                Tmax = (345.11, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.25415, 0.07726, -4.79941e-05, 1.43476e-08, -1.65241e-12, 13496.9, 36.9687],
                Tmin = (345.11, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.8507, 0.00911754, 0.000234697, -4.61266e-07, 2.80881e-10, 13264.2, 12.2953],
                Tmin = (10, 'K'),
                Tmax = (522.569, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.884215, 0.0766366, -4.88867e-05, 1.50468e-08, -1.78165e-12, 13332.1, 27.9796],
                Tmin = (522.569, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.87145, 0.00797269, 0.000286891, -5.46886e-07, 3.30988e-10, 14143.1, 15.3232],
                Tmin = (10, 'K'),
                Tmax = (495.001, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-4.82043, 0.101076, -6.45337e-05, 1.9735e-08, -2.31577e-12, 14723.4, 48.3147],
                Tmin = (495.001, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.57245, 0.0393686, 0.000160945, -2.89353e-07, 1.46447e-10, 10995.7, 15.1443],
                Tmin = (10, 'K'),
                Tmax = (650.006, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-1.31402, 0.102689, -6.19095e-05, 1.79116e-08, -1.99908e-12, 10928.5, 31.2104],
                Tmin = (650.006, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.33, 0.0603379, 0.000113878, -2.24108e-07, 1.11512e-10, 7869.6, 16.29],
                Tmin = (10, 'K'),
                Tmax = (683.912, 'K'),
            ),
            NASAPolynomial(
                coeffs = [0.178328, 0.1105, -6.57292e-05, 1.8805e-08, -2.07976e-12, 7558.66, 24.8727],
                Tmin = (683.912, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.92096, 0.00515781, 0.000281383, -5.4323e-07, 3.41557e-10, -1654.73, 13.2929],
                Tmin = (10, 'K'),
                Tmax = (409.297, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-5.73827, 0.099538, -6.44375e-05, 1.99373e-08, -2.36147e-12, -863.879, 51.2662],
                Tmin = (409.297, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.65715, 0.0324995, 0.000173031, -3.02031e-07, 1.51736e-10, -4804.32, 13.6175],
                Tmin = (10, 'K'),
                Tmax = (650.823, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-1.68411, 0.0994848, -6.00804e-05, 1.73971e-08, -1.94243e-12, -4832.49, 31.5341],
                Tmin = (650.823, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.40999, 0.0552511, 0.000114719, -2.14633e-07, 1.03074e-10, -7962.13, 14.526],
                Tmin = (10, 'K'),
                Tmax = (710.114, 'K'),
            ),
            NASAPolynomial(
                coeffs = [0.289053, 0.106048, -6.27461e-05, 1.78466e-08, -1.96282e-12, -8356.39, 22.6174],
                Tmin = (710.114, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.93261, 0.00413367, 0.000215054, -3.85136e-07, 2.21506e-10, 20787.2, 12.3971],
                Tmin = (10, 'K'),
                Tmax = (450.293, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-5.31695, 0.0861841, -5.78892e-05, 1.83963e-08, -2.21985e-12, 21621.3, 49.6539],
                Tmin = (450.293, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.86021, 0.00837721, 0.000258425, -4.8236e-07, 2.81146e-10, 16689.5, 14.7443],
                Tmin = (10, 'K'),
                Tmax = (531.007, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.58728, 0.0928827, -6.05253e-05, 1.88114e-08, -2.23461e-12, 17080, 42.1893],
                Tmin = (531.007, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.91998, 0.00547133, 0.000286726, -5.93413e-07, 4.03433e-10, 15304.3, 14.8887],
                Tmin = (10, 'K'),
                Tmax = (376.737, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-4.26068, 0.0922982, -5.88556e-05, 1.7903e-08, -2.08614e-12, 15920.9, 46.3725],
                Tmin = (376.737, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.63048, 0.0379893, 0.000138553, -2.42553e-07, 1.16875e-10, 13462.4, 14.4229],
                Tmin = (10, 'K'),
                Tmax = (699.543, 'K'),
            ),
            NASAPolynomial(
                coeffs = [0.346596, 0.0926916, -5.57754e-05, 1.60546e-08, -1.78084e-12, 13042.9, 22.8095],
                Tmin = (699.543, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.74375, 0.040327, 0.000104701, -1.66257e-07, 6.93336e-11, 12289.2, 14.2845],
                Tmin = (10, 'K'),
                Tmax = (835.823, 'K'),
            ),
            NASAPolynomial(
                coeffs = [2.31239, 0.086802, -4.98173e-05, 1.37097e-08, -1.46114e-12, 11144.4, 12.6534],
                Tmin = (835.823, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.39035, 0.0610035, 7.99589e-05, -1.58513e-07, 7.27885e-11, 10319.6, 15.3331],
                Tmin = (10, 'K'),
                Tmax = (775.75, 'K'),
            ),
            NASAPolynomial(
                coeffs = [2.8705, 0.0978084, -5.71908e-05, 1.60557e-08, -1.74384e-12, 9373.46, 11.091],
                Tmin = (775.75, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.63145, 0.060064, 5.88229e-05, -1.06e-07, 4.12778e-11, 8994.54, 14.3421],
                Tmin = (10, 'K'),
                Tmax = (956.069, 'K'),
            ),
            NASAPolynomial(
                coeffs = [6.72759, 0.0875392, -4.77132e-05, 1.25168e-08, -1.27841e-12, 6554.79, -10.119],
                Tmin = (956.069, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [4.12648, -0.0123417, 0.000280961, -4.80678e-07, 2.61244e-10, 14971.7, 11.5839],
                Tmin = (10, 'K'),
                Tmax = (586.093, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.51184, 0.0745743, -4.79801e-05, 1.46194e-08, -1.69721e-12, 15035.1, 33.9663],
                Tmin = (586.093, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.87326, 0.00747494, 0.000240528, -4.37359e-07, 2.48011e-10, 11037.2, 12.9198],
                Tmin = (10, 'K'),
                Tmax = (543.271, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.86147, 0.0903139, -5.96771e-05, 1.87515e-08, -2.24574e-12, 11495.6, 41.9998],
                Tmin = (543.271, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.87494, 0.00766011, 0.000248265, -4.72926e-07, 2.83475e-10, 9471.61, 12.4502],
                Tmin = (10, 'K'),
                Tmax = (510.06, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.19975, 0.0871573, -5.61498e-05, 1.72662e-08, -2.03269e-12, 9880.91, 38.7562],
                Tmin = (510.06, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.83518, 0.0106899, 0.000312449, -6.49336e-07, 4.26128e-10, 8044.85, 14.7468],
                Tmin = (10, 'K'),
                Tmax = (468.75, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.97546, 0.0983983, -6.29085e-05, 1.91772e-08, -2.2373e-12, 8358.26, 38.9762],
                Tmin = (468.75, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.85385, 0.00990698, 0.000323347, -6.98214e-07, 4.83402e-10, 6523.03, 14.3821],
                Tmin = (10, 'K'),
                Tmax = (431.533, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.25898, 0.0983784, -6.25292e-05, 1.89617e-08, -2.20327e-12, 6927.04, 40.2879],
                Tmin = (431.533, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.4936, 0.0548245, 8.80631e-05, -1.63331e-07, 7.32913e-11, 4793.34, 14.4459],
                Tmin = (10, 'K'),
                Tmax = (789.565, 'K'),
            ),
            NASAPolynomial(
                coeffs = [2.92874, 0.0938657, -5.484e-05, 1.53632e-08, -1.66432e-12, 3754.8, 9.89611],
                Tmin = (789.565, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.57227, 0.0515251, 9.19646e-05, -1.60443e-07, 6.92396e-11, 3283.5, 14.8218],
                Tmin = (10, 'K'),
                Tmax = (819.095, 'K'),
            ),
            NASAPolynomial(
                coeffs = [2.87998, 0.0929882, -5.37061e-05, 1.4881e-08, -1.59636e-12, 2119.41, 10.2253],
                Tmin = (819.095, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.90822, 0.00556102, 0.000268158, -4.75068e-07, 2.71104e-10, 12058.3, 13.0231],
                Tmin = (10, 'K'),
                Tmax = (454.826, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-7.69058, 0.107814, -6.98823e-05, 2.16116e-08, -2.55652e-12, 13110.9, 59.8146],
                Tmin = (454.826, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.86316, 0.00863059, 0.000331304, -6.39874e-07, 3.94974e-10, 8032.38, 14.9886],
                Tmin = (10, 'K'),
                Tmax = (478.421, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-6.15246, 0.11497, -7.29663e-05, 2.22085e-08, -2.59689e-12, 8732.07, 53.2208],
                Tmin = (478.421, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.98095, -0.000430483, 0.000276899, -4.72432e-07, 2.5606e-10, -2021.78, 12.7905],
                Tmin = (10, 'K'),
                Tmax = (561.625, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-5.89597, 0.0980584, -6.13135e-05, 1.82617e-08, -2.08374e-12, -1356.21, 50.7912],
                Tmin = (561.625, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.90763, 0.00613766, 0.000329619, -6.53365e-07, 4.23669e-10, -5855.27, 14.1693],
                Tmin = (10, 'K'),
                Tmax = (395.99, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-6.57847, 0.112047, -7.15083e-05, 2.18617e-08, -2.56504e-12, -5024.69, 55.0461],
                Tmin = (395.99, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.92103, 0.00492435, 0.000257755, -4.71132e-07, 2.7786e-10, 15315.4, 12.7165],
                Tmin = (10, 'K'),
                Tmax = (439.897, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-6.44992, 0.0995149, -6.57672e-05, 2.06512e-08, -2.47112e-12, 16225, 54.202],
                Tmin = (439.897, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.90618, 0.00637912, 0.000327572, -6.74205e-07, 4.55856e-10, 10704.8, 15.0788],
                Tmin = (10, 'K'),
                Tmax = (379.13, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-5.54236, 0.106115, -6.72226e-05, 2.03511e-08, -2.36375e-12, 11420.9, 51.4939],
                Tmin = (379.13, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.84484, 0.00946585, 0.000302092, -5.73677e-07, 3.42289e-10, 11638.5, 14.6987],
                Tmin = (10, 'K'),
                Tmax = (514.157, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-4.70857, 0.106235, -6.84021e-05, 2.1051e-08, -2.48165e-12, 12118.5, 46.3887],
                Tmin = (514.157, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.88284, 0.00854295, 0.000409761, -9.32105e-07, 7.03554e-10, 7675.74, 15.5384],
                Tmin = (10, 'K'),
                Tmax = (337.89, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-5.32232, 0.117513, -7.39788e-05, 2.23052e-08, -2.58435e-12, 8297.82, 49.9603],
                Tmin = (337.89, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.88569, 0.00829346, 0.000407941, -9.1989e-07, 6.87602e-10, 8989.55, 15.839],
                Tmin = (10, 'K'),
                Tmax = (341.365, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-5.48684, 0.118118, -7.4645e-05, 2.25776e-08, -2.62144e-12, 9629.43, 50.9824],
                Tmin = (341.365, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.92322, 0.00469741, 0.00023911, -4.2755e-07, 2.45774e-10, 10441.6, 11.8044],
                Tmin = (10, 'K'),
                Tmax = (450.877, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-6.33371, 0.0956917, -6.36106e-05, 2.00471e-08, -2.40401e-12, 11366.6, 53.118],
                Tmin = (450.877, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.85493, 0.00898588, 0.000292264, -5.64393e-07, 3.43868e-10, 5759.89, 13.1356],
                Tmin = (10, 'K'),
                Tmax = (500.64, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-4.19583, 0.100667, -6.43965e-05, 1.96981e-08, -2.31031e-12, 6223.15, 42.9817],
                Tmin = (500.64, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.85456, 0.00877977, 0.000285495, -5.3358e-07, 3.12891e-10, 6680.76, 13.7415],
                Tmin = (10, 'K'),
                Tmax = (522.457, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-4.70306, 0.102889, -6.67846e-05, 2.06809e-08, -2.44921e-12, 7184.75, 45.7369],
                Tmin = (522.457, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.89095, 0.00790323, 0.0003922, -8.82366e-07, 6.57738e-10, 2863.52, 14.3294],
                Tmin = (10, 'K'),
                Tmax = (342.367, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-5.18089, 0.113893, -7.2168e-05, 2.18659e-08, -2.54144e-12, 3484.7, 48.3719],
                Tmin = (342.367, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.63851, 0.040388, 0.000146556, -2.4654e-07, 1.14035e-10, 3118.96, 14.0539],
                Tmin = (10, 'K'),
                Tmax = (730.889, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.0490767, 0.10078, -5.99094e-05, 1.70557e-08, -1.87402e-12, 2583.98, 23.3411],
                Tmin = (730.889, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.89212, 0.00631001, 0.000227169, -4.02625e-07, 2.23242e-10, 24248.2, 12.7799],
                Tmin = (10, 'K'),
                Tmax = (545.007, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-4.70453, 0.0901466, -6.06608e-05, 1.92886e-08, -2.32777e-12, 24877.2, 46.2097],
                Tmin = (545.007, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.83251, 0.00997216, 0.000277293, -5.21955e-07, 3.04113e-10, 20490.5, 13.9718],
                Tmin = (10, 'K'),
                Tmax = (541.059, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.21384, 0.0975899, -6.40998e-05, 2.00427e-08, -2.3914e-12, 20733, 38.8331],
                Tmin = (541.059, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.8442, 0.00990569, 0.000293443, -5.94037e-07, 3.78699e-10, 19656.1, 15.0652],
                Tmin = (10, 'K'),
                Tmax = (483.667, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.94124, 0.095087, -6.08693e-05, 1.85762e-08, -2.1704e-12, 19972.6, 39.3579],
                Tmin = (483.667, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.82248, 0.012031, 0.000359447, -7.83632e-07, 5.44838e-10, 16745.8, 15.8043],
                Tmin = (10, 'K'),
                Tmax = (435.801, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.54395, 0.108037, -6.8726e-05, 2.08642e-08, -2.42724e-12, 17118.3, 42.1313],
                Tmin = (435.801, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.80001, 0.0132491, 0.000354645, -7.63159e-07, 5.17377e-10, 16960.6, 16.4373],
                Tmin = (10, 'K'),
                Tmax = (457.035, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.03356, 0.107733, -6.92646e-05, 2.11989e-08, -2.47921e-12, 17223, 40.0926],
                Tmin = (457.035, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [4.1155, -0.0118741, 0.000302555, -5.25571e-07, 2.89125e-10, 12983.2, 12.1184],
                Tmin = (10, 'K'),
                Tmax = (581.285, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.55933, 0.0797241, -5.16554e-05, 1.58185e-08, -1.84313e-12, 12987.7, 34.0631],
                Tmin = (581.285, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.85335, 0.0088481, 0.000263357, -4.98642e-07, 2.94455e-10, 8343.85, 12.7883],
                Tmin = (10, 'K'),
                Tmax = (526.62, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.25195, 0.0926529, -6.03314e-05, 1.87081e-08, -2.21644e-12, 8678.49, 38.5828],
                Tmin = (526.62, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.82344, 0.0109891, 0.00031613, -6.2575e-07, 3.87798e-10, 5484.1, 14.2484],
                Tmin = (10, 'K'),
                Tmax = (501.992, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.60545, 0.104749, -6.73134e-05, 2.06413e-08, -2.42317e-12, 5794.45, 40.631],
                Tmin = (501.992, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.39432, 0.0844029, 2.03879e-06, -4.3642e-08, 1.73122e-11, 6763.06, 14.8815],
                Tmin = (10, 'K'),
                Tmax = (1114.23, 'K'),
            ),
            NASAPolynomial(
                coeffs = [13.5446, 0.0823604, -4.15166e-05, 1.01234e-08, -9.67382e-13, 2365.95, -44.7671],
                Tmin = (1114.23, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.45855, 0.0653917, 7.43923e-05, -1.34807e-07, 5.51659e-11, 5386.86, 14.6137],
                Tmin = (10, 'K'),
                Tmax = (885.75, 'K'),
            ),
            NASAPolynomial(
                coeffs = [3.84315, 0.103556, -5.78104e-05, 1.55549e-08, -1.62786e-12, 3753.49, 3.96925],
                Tmin = (885.75, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.44008, 0.0497685, 0.000179846, -3.36273e-07, 1.75281e-10, -2490.91, 14.7129],
                Tmin = (10, 'K'),
                Tmax = (629.735, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-1.99102, 0.120005, -7.25798e-05, 2.10769e-08, -2.36093e-12, -2515.51, 32.7767],
                Tmin = (629.735, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.64358, 0.0492086, 0.000131897, -2.06411e-07, 8.5801e-11, -5322.43, 13.8889],
                Tmin = (10, 'K'),
                Tmax = (828.208, 'K'),
            ),
            NASAPolynomial(
                coeffs = [0.236516, 0.111341, -6.336e-05, 1.73522e-08, -1.84441e-12, -6324.63, 20.2263],
                Tmin = (828.208, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.89159, 0.00634791, 0.00022797, -4.04814e-07, 2.24798e-10, 26566.8, 12.4503],
                Tmin = (10, 'K'),
                Tmax = (544.99, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-4.65161, 0.0901411, -6.07034e-05, 1.93162e-08, -2.33266e-12, 27184.8, 45.6072],
                Tmin = (544.99, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.82797, 0.0104668, 0.00028409, -5.51569e-07, 3.32381e-10, 21938, 13.7061],
                Tmin = (10, 'K'),
                Tmax = (523.36, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.67379, 0.0957097, -6.21154e-05, 1.92256e-08, -2.27571e-12, 22131.7, 36.2121],
                Tmin = (523.36, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.85688, 0.00880585, 0.000280157, -5.38396e-07, 3.25335e-10, 21944.4, 14.9448],
                Tmin = (10, 'K'),
                Tmax = (507.19, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.87017, 0.0972536, -6.27785e-05, 1.93025e-08, -2.2699e-12, 22374.4, 43.4897],
                Tmin = (507.19, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.62225, 0.0373221, 0.000163865, -2.91385e-07, 1.45434e-10, 19162.8, 14.9938],
                Tmin = (10, 'K'),
                Tmax = (669.188, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.274375, 0.0989605, -6.0254e-05, 1.75214e-08, -1.96032e-12, 18825.7, 25.8122],
                Tmin = (669.188, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.61209, 0.0387323, 0.000156878, -2.79046e-07, 1.381e-10, 18836.2, 14.9083],
                Tmin = (10, 'K'),
                Tmax = (678.013, 'K'),
            ),
            NASAPolynomial(
                coeffs = [0.0161261, 0.0982899, -5.97119e-05, 1.73274e-08, -1.935e-12, 18442.5, 24.3602],
                Tmin = (678.013, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.48724, 0.0455332, 7.2703e-05, -1.44879e-07, 7.10701e-11, 9343.34, 13.7942],
                Tmin = (10, 'K'),
                Tmax = (693.808, 'K'),
            ),
            NASAPolynomial(
                coeffs = [1.05501, 0.0802776, -4.72142e-05, 1.33952e-08, -1.47221e-12, 9182.09, 21.0449],
                Tmin = (693.808, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.69834, 0.0462443, 4.48277e-05, -7.92318e-08, 3.04101e-11, 9726.29, 13.9905],
                Tmin = (10, 'K'),
                Tmax = (964.837, 'K'),
            ),
            NASAPolynomial(
                coeffs = [5.46529, 0.0689445, -3.7143e-05, 9.66075e-09, -9.80297e-13, 7987.77, -1.71318],
                Tmin = (964.837, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.69079, 0.0433297, 5.69857e-05, -9.60088e-08, 3.79145e-11, 9896.37, 13.7092],
                Tmin = (10, 'K'),
                Tmax = (913.467, 'K'),
            ),
            NASAPolynomial(
                coeffs = [3.93704, 0.0722527, -3.97737e-05, 1.05629e-08, -1.09252e-12, 8599.7, 5.69214],
                Tmin = (913.467, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.76277, 0.0182904, 0.000297464, -7.2276e-07, 5.53455e-10, 9821.42, 13.1829],
                Tmin = (10, 'K'),
                Tmax = (402.709, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.726715, 0.0880112, -5.58262e-05, 1.70381e-08, -1.99685e-12, 9979.26, 28.2289],
                Tmin = (402.709, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.624, 0.0586681, 0.000103052, -1.74247e-07, 7.22558e-11, 22992.5, 16.7977],
                Tmin = (10, 'K'),
                Tmax = (865.008, 'K'),
            ),
            NASAPolynomial(
                coeffs = [4.63489, 0.103036, -5.8928e-05, 1.61355e-08, -1.71037e-12, 20982.9, 1.46192],
                Tmin = (865.008, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.50031, 0.0658136, 8.59032e-05, -1.61328e-07, 6.93597e-11, 23198.7, 17.6902],
                Tmin = (10, 'K'),
                Tmax = (850.112, 'K'),
            ),
            NASAPolynomial(
                coeffs = [5.81432, 0.101325, -5.86278e-05, 1.62186e-08, -1.73422e-12, 21128.7, -2.95906],
                Tmin = (850.112, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.63494, 0.0563722, 0.000116057, -1.95483e-07, 8.28483e-11, 23194.5, 17.7811],
                Tmin = (10, 'K'),
                Tmax = (839.592, 'K'),
            ),
            NASAPolynomial(
                coeffs = [4.17989, 0.104523, -6.06326e-05, 1.68053e-08, -1.79966e-12, 21314.4, 4.59562],
                Tmin = (839.592, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
9  C u0 p0 c0 {2,S} {10,S} {23,S} {24,S}
10 C u0 p0 c0 {9,S} {11,D} {15,S}
11 C u0 p0 c0 {10,D} {12,S} {25,S}
12 C u0 p0 c0 {11,S} {13,D} {26,S}
13 C u0 p0 c0 {12,D} {14,S} {27,S}
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.71463, 0.0179551, 0.000412954, -8.58956e-07, 5.49786e-10, 23744, 18.6462],
                Tmin = (10, 'K'),
                Tmax = (502.298, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.86402, 0.127313, -8.37464e-05, 2.60782e-08, -3.08888e-12, 23686.2, 38.7006],
                Tmin = (502.298, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
6  C u1 p0 c0 {5,S} {7,S} {8,S}
7  H u0 p0 c0 {6,S}
8  C u0 p0 c0 {2,S} {6,S} {9,S} {23,S}
9  C u0 p0 c0 {8,S} {10,S} {11,S} {24,S}
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.41113, 0.0689027, 0.000112407, -2.05064e-07, 9.04846e-11, 19677.6, 17.7948],
                Tmin = (10, 'K'),
                Tmax = (808.076, 'K'),
            ),
            NASAPolynomial(
                coeffs = [3.49931, 0.11741, -6.84902e-05, 1.91313e-08, -2.06559e-12, 18065.4, 7.50052],
                Tmin = (808.076, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
3  C u1 p0 c0 {2,S} {4,S} {5,S}
4  H u0 p0 c0 {3,S}
5  C u0 p0 c0 {3,S} {6,S} {9,S} {20,S}
6  C u0 p0 c0 {5,S} {7,D} {21,S}
7  C u0 p0 c0 {6,D} {8,S} {22,S}
8  C u0 p0 c0 {2,D} {7,S} {23,S}
9  C u0 p0 c0 {5,S} {10,S} {11,S} {24,S}
10 C u0 p0 c0 {9,S} {25,S} {26,S} {27,S}
11 C u0 p0 c0 {9,S} {12,D} {16,S}
12 C u0 p0 c0 {11,D} {13,S} {28,S}
13 C u0 p0 c0 {12,S} {14,D} {29,S}
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.34844, 0.0795031, 6.87806e-05, -1.43352e-07, 6.1253e-11, 19592.1, 20.9026],
                Tmin = (10, 'K'),
                Tmax = (875.57, 'K'),
            ),
            NASAPolynomial(
                coeffs = [6.82556, 0.109921, -6.26569e-05, 1.71248e-08, -1.81339e-12, 17208.4, -5.54589],
                Tmin = (875.57, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.4711, 0.0768185, 7.08214e-05, -1.38502e-07, 5.67836e-11, 19431.5, 18.9654],
                Tmin = (10, 'K'),
                Tmax = (914.69, 'K'),
            ),
            NASAPolynomial(
                coeffs = [7.89441, 0.107058, -6.00786e-05, 1.61662e-08, -1.68736e-12, 16548.1, -13.3183],
                Tmin = (914.69, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
9  C u0 p0 c0 {2,S} {10,S} {11,S} {16,S}
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.32559, 0.0596109, 0.000213904, -4.36371e-07, 2.44089e-10, 19889.5, 17.0929],
                Tmin = (10, 'K'),
                Tmax = (602.201, 'K'),
            ),
            NASAPolynomial(
                coeffs = [0.152147, 0.129327, -8.08973e-05, 2.41061e-08, -2.75341e-12, 19389.8, 23.4711],
                Tmin = (602.201, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.93322, 0.00430268, 0.000196257, -3.78428e-07, 2.39028e-10, 5494.59, 10.9614],
                Tmin = (10, 'K'),
                Tmax = (406.257, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.61898, 0.0688083, -4.18875e-05, 1.23226e-08, -1.40337e-12, 6027.03, 36.6707],
                Tmin = (406.257, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.93497, 0.00417536, 0.000196155, -3.75578e-07, 2.35257e-10, 5167.09, 10.8908],
                Tmin = (10, 'K'),
                Tmax = (410.076, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.75432, 0.0694353, -4.25957e-05, 1.26264e-08, -1.44776e-12, 5715.62, 37.1988],
                Tmin = (410.076, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.93104, 0.00445205, 0.000196414, -3.80834e-07, 2.42095e-10, 5324.11, 11.2405],
                Tmin = (10, 'K'),
                Tmax = (403.453, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.5211, 0.0684177, -4.13905e-05, 1.20931e-08, -1.36837e-12, 5844.77, 36.5122],
                Tmin = (403.453, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.9381, 0.00386964, 0.000191993, -3.52802e-07, 2.10486e-10, 6348.11, 10.649],
                Tmin = (10, 'K'),
                Tmax = (432.159, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.46759, 0.0723999, -4.58172e-05, 1.39695e-08, -1.63956e-12, 6988.34, 40.1657],
                Tmin = (432.159, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.93723, 0.00391638, 0.00019108, -3.50841e-07, 2.09217e-10, 6549.51, 11.0684],
                Tmin = (10, 'K'),
                Tmax = (433.111, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-3.42987, 0.0720742, -4.53838e-05, 1.37707e-08, -1.60957e-12, 7186.55, 40.433],
                Tmin = (433.111, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.73822, 0.0222163, 0.000145645, -2.66654e-07, 1.46468e-10, 1048.24, 12.1204],
                Tmin = (10, 'K'),
                Tmax = (558.346, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-1.90119, 0.0782783, -4.70399e-05, 1.36493e-08, -1.53195e-12, 1433.87, 33.8547],
                Tmin = (558.346, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.79764, 0.0166902, 0.000186677, -3.6295e-07, 2.19763e-10, 2580.75, 13.0297],
                Tmin = (10, 'K'),
                Tmax = (491.681, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.23373, 0.0798068, -4.87366e-05, 1.43603e-08, -1.63356e-12, 3004.03, 36.1188],
                Tmin = (491.681, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.69769, 0.0268197, 0.000113751, -1.96971e-07, 9.77797e-11, 1673.88, 12.4184],
                Tmin = (10, 'K'),
                Tmax = (642.434, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-1.23025, 0.0761322, -4.48854e-05, 1.27865e-08, -1.41181e-12, 1922.61, 31.0202],
                Tmin = (642.434, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.72457, 0.0238137, 0.000134794, -2.40971e-07, 1.2704e-10, 1388.38, 12.2129],
                Tmin = (10, 'K'),
                Tmax = (593.949, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-1.58052, 0.0775409, -4.63499e-05, 1.33738e-08, -1.49316e-12, 1701.08, 32.3704],
                Tmin = (593.949, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.73352, 0.0225704, 0.000148919, -2.80645e-07, 1.59731e-10, 991.042, 12.2407],
                Tmin = (10, 'K'),
                Tmax = (529.981, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-1.92972, 0.0786375, -4.7479e-05, 1.38418e-08, -1.56026e-12, 1404.2, 34.2015],
                Tmin = (529.981, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.6999, 0.0266601, 0.000116008, -2.01532e-07, 1.00504e-10, 1302.17, 12.4077],
                Tmin = (10, 'K'),
                Tmax = (640.373, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-1.182, 0.0762971, -4.5101e-05, 1.2874e-08, -1.42366e-12, 1534.91, 30.7195],
                Tmin = (640.373, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.74212, 0.0226251, 0.000152294, -2.99959e-07, 1.82827e-10, 1338.96, 12.2318],
                Tmin = (10, 'K'),
                Tmax = (425.825, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.3221, 0.0795894, -4.8367e-05, 1.41932e-08, -1.60959e-12, 1855.42, 36.3109],
                Tmin = (425.825, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.89729, 0.00687514, 0.000259496, -5.4318e-07, 3.67471e-10, 2653.04, 12.3589],
                Tmin = (10, 'K'),
                Tmax = (433.815, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.44012, 0.0808426, -4.99702e-05, 1.49313e-08, -1.72396e-12, 3056.73, 35.956],
                Tmin = (433.815, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.83266, 0.0106198, 0.000259514, -5.39988e-07, 3.49291e-10, 1580.87, 11.3135],
                Tmin = (10, 'K'),
                Tmax = (492.893, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-0.467264, 0.0788279, -4.94401e-05, 1.50123e-08, -1.75963e-12, 1600.09, 24.9113],
                Tmin = (492.893, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.87423, 0.00801583, 0.000249858, -5.03144e-07, 3.21106e-10, 1867.79, 11.8401],
                Tmin = (10, 'K'),
                Tmax = (479.629, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.05094, 0.0807002, -5.0231e-05, 1.51223e-08, -1.75846e-12, 2168.52, 33.2819],
                Tmin = (479.629, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
...
8  C u0 p0 c0 {7,D} {9,S} {21,S}
9  C u0 p0 c0 {3,S} {8,S} {22,S} {23,S}
10 H u0 p0 c0 {1,S}
11 H u0 p0 c0 {1,S}
12 H u0 p0 c0 {1,S}
13 H u0 p0 c0 {2,S}
