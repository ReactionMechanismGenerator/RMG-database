...
longDesc = """
J.M. Velasco, K. Kaplan, K.A. Spiekerman, A. Menon, C. Cao, W.H. Green, A. Grinberg Dana,
"Yet another NH3 oxidation kinetic model, and a path forward", 2023, In Progress.

Based on 1DHR RRHO CCSD(T)-F12/cc-pVTZ-F12//B2PLYPD3/aug-cc-pVTZ computations
with enthalpies from ATcT where available.
"""
