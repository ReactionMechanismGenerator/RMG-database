...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.6256, 0.0469135, 0.000136796, -2.12104e-07, 8.86679e-11, -3026.35, 13.2408],
                Tmin = (10, 'K'),
                Tmax = (813.759, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-1.05584, 0.112965, -6.42909e-05, 1.76295e-08, -1.87734e-12, -3689.49, 26.1053],
                Tmin = (813.759, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],
