...
# # CH3CHCHCHO Thermochemistry
# 
# Note: Convert this .py into a .ipynb file by running `jupyter nbconvert --to notebook CH3CHCHCHO.py`
# or `jupytext --to notebook CH3CHCHCHO.py` or `jupytext --sync CH3CHCHCHO.py`.
# 
...
# used.
# 
# The species is (SMILES `C[CH][CH][CH][O]`)
# 
# ```
# multiplicity 5
...
# 
# The `CH3CHCHCHO` entry (`T 5/92`) is identical across JetSurF1.0, JetSurf2.0,
# USC_Mech_ii and 2-BTP.
# 
# A different NASA polynomial was found in the website of [AramcoMech1.3](https://www.universityofgalway.ie/media/researchcentres/combustionchemistrycentre/files/mechanismdownloads/AramcoMech_1.3_therm.dat) but not in [2.0](https://www.universityofgalway.ie/media/researchcentres/combustionchemistrycentre/files/mechanismdownloads/aramcomech2/ARAMCOMECH20.THERM)
# 
# as
# 
# ```
# CH3CHCHCHO              C   4H   6O   1    0G   300.000  5000.000 1390.000    21
#  1.32324148E+01 1.41733450E-02-4.87794340E-06 7.60567717E-10-4.42613504E-14    2
# -2.02867889E+04-4.48216674E+01 7.26850107E-01 4.38069262E-02-3.21167642E-05    3
#  1.23413678E-08-1.96193679E-12-1.59649030E+04 2.22276969E+01                   4
# ```
# 
# and in the original publication as
# 
# ```
...
# ```
# 
# The conclusion of this analysis is that the NASA polynomial for the `CH3CHCHCHO` was updated in AramcoMech1.3, and not because the original measurement of AramcoMech1.3 was wrong, but it was incorrectly fitted as we found in this analysis that refitting the thermodynamic properties of the [supplementary material](https://onlinelibrary.wiley.com/action/downloadSupplement?doi=10.1002%2Fkin.20802&file=Supp_Mat_V9.pdf) presented in the AramcoMech1.3 publication aligns with the updated NASA in AramcoMech1.3.

# In[2]:


# This NASA polynomial entry was found in the original AramcoMech1.3 paper and used unchanged in RMG libraries.
...
Cp_target = np.array([18.29, 24.07 , 29.17, 33.59, 40.42, 44.55, 50.64])  # cal/mol/K.
H_target = -25.70   # kcal/mol  (ΔHf at 298 K)
S_target = 79.62   # cal/mol/K (S at 298 K)
...
m = Molecule(smiles='C[CH][CH][CH][O]')   # matches the notebook's adjacency list
